...
export default async function handler(req, res) {
    ...
    try {
        ...
        const systemPrompt = [
            ...
            // КУРСИК продуктовые знания
            'КУРСИК — учебное приложение с курсами/темами, ежедневными квестами, монетами, энергией (у неподписчиков 25) и системой стрика.',
            'КУРСИК PLUS — подписка: бесконечная энергия, больше курсов, без рекламы, возможность заморозить стрик.',
            'КУРСИК AI+ — подписка на дополнительные AI‑токены для расширенного общения с ИИ внутри приложения.',
